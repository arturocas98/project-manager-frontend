...
export class ApiService {
    ...
    buildHttpResponse<T>(
        ...
        if (request && (method === HttpMethodType.POST || method === HttpMethodType.PUT || method === HttpMethodType.PATCH)) {
    ...
    // GET request
    get<T>(endPoint: string, extraKeys?: ExtraKeys, parser?: (data: any) => T): Observable<T> {
    ...
    // POST request
    post<T>(endPoint: string, data: any, extraKeys?: ExtraKeys, parser?: (data: any) => T): Observable<T> {
        return this.request<T>(
            endPoint,
            HttpMethodType.POST,
            data,
    ...
    // PUT request
    put<T>(endPoint: string, data: any, extraKeys?: ExtraKeys, parser?: (data: any) => T): Observable<T> {
        return this.request<T>(
            endPoint,
            HttpMethodType.PUT,
            data,
    ...
    // DELETE request
    delete<T>(endPoint: string, extraKeys?: ExtraKeys, parser?: (data: any) => T): Observable<T> {
        return this.request<T>(
            endPoint,
    ...
    // PATCH request
    patch<T>(endPoint: string, data: any, extraKeys?: ExtraKeys, parser?: (data: any) => T): Observable<T> {
        return this.request<T>(
            endPoint,
    ...
    // Crear registro
    create<T>(endPoint: string, data: any, parser?: (data: any) => T): Observable<T> {
    ...
    // Actualizar registro
    update<T>(endPoint: string, data: any, parser?: (data: any) => T): Observable<T> {
