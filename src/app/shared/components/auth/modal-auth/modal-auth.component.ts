...
import { TimedModalService } from "src/app/core/service/Modals/timed-modal.service";
...
export class ModalAuthComponent {
  ...
  private showModal() {
    ...
    this.currentType =
      config.type || this.getTypeFromStatusCode(config.statusCode);
    ...
    this.confirmationService.confirm({
      ...
      rejectLabel:
        this.currentType === "error" || this.currentType === "warning"
          ? "Cancelar"
          : undefined,
  ...
  private setupModalStyle() {
    switch (this.currentType) {
      case "success":
        ...
        this.acceptButtonClass =
          "bg-green-600 hover:bg-green-700 border-green-600";
        this.rejectButtonClass =
